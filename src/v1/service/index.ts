...
import { CreateStoreService, GetAllStoresService, GetStoreByIdSerive, InactiveStoreService } from './store.service';
...
export {
    ...
    CreatGenderService,
    CreateStoreService, GetAllStoresService, GetStoreByIdSerive, InactiveStoreService,
    SigninService
}